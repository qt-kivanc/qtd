(function (global, factory) {
      typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@babel/runtime/helpers/slicedToArray'), require('react'), require('uuid'), require('react-dom'), require('@babel/runtime/helpers/defineProperty'), require('react-transition-group'), require('autoprefixer'), require('nanoid'), require('@babel/runtime/helpers/taggedTemplateLiteral'), require('styled-components'), require('@babel/runtime/helpers/toConsumableArray'), require('react-spring'), require('@babel/runtime/helpers/extends'), require('simplebar-react'), require('@babel/runtime/helpers/typeof'), require('react-router-dom'), require('@babel/runtime/helpers/objectWithoutProperties'), require('react-svg'), require('moment'), require('axios'), require('react-input-mask'), require('react-number-format'), require('query-string')) :
      typeof define === 'function' && define.amd ? define(['exports', '@babel/runtime/helpers/slicedToArray', 'react', 'uuid', 'react-dom', '@babel/runtime/helpers/defineProperty', 'react-transition-group', 'autoprefixer', 'nanoid', '@babel/runtime/helpers/taggedTemplateLiteral', 'styled-components', '@babel/runtime/helpers/toConsumableArray', 'react-spring', '@babel/runtime/helpers/extends', 'simplebar-react', '@babel/runtime/helpers/typeof', 'react-router-dom', '@babel/runtime/helpers/objectWithoutProperties', 'react-svg', 'moment', 'axios', 'react-input-mask', 'react-number-format', 'query-string'], factory) :
      (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory(global["qt-design"] = {}, global._slicedToArray, global.React, global.uuid, global.ReactDOM, global._defineProperty, global.reactTransitionGroup, global.autoprefixer, global.nanoid, global._taggedTemplateLiteral, global.styled, global._toConsumableArray, global.reactSpring, global._extends, global.SimpleBar, global._typeof, global.reactRouterDom, global._objectWithoutProperties, global.reactSvg, global.moment, global.axios, global.InputMask, global.NumberFormat, global.queryString));
})(this, (function (exports, _slicedToArray, React, uuid, reactDom, _defineProperty, reactTransitionGroup, autoprefixer, nanoid, _taggedTemplateLiteral, styled, _toConsumableArray, reactSpring, _extends, SimpleBar, _typeof, reactRouterDom, _objectWithoutProperties, reactSvg, moment, axios, InputMask, NumberFormat, queryString) { 'use strict';
      ...
      var useCreateStyledStyle = function useCreateStyledStyle(styled) {
        ...
        if (handler) id += "-" + nanoid.nanoid(11);
      ...
      var Overlay = styled.div(_templateObject2$n || (_templateObject2$n = _taggedTemplateLiteral(["\n  \n  background: #000000BF;\n  position: fixed;\n  top: 0;\n  left: 0;\n  width: 100vw;\n  height: 100vh;\n  transition: opacity .25s ease-out;\n  opacity: 0;\n\n  ", "\n\n  "])), function (_ref) {
        var show = _ref.show;
        return show ? styled.css(_templateObject3$m || (_templateObject3$m = _taggedTemplateLiteral(["\n        opacity: 1;\n      "]))) : styled.css(_templateObject4$k || (_templateObject4$k = _taggedTemplateLiteral(["\n        opacity: 0;\n      "])));
      });

      var Container$3 = function Container(_ref) {
        var _ref$id = _ref.id,
          id = _ref$id === void 0 ? uuid.v4() : _ref$id,
        ...
        return /*#__PURE__*/reactDom.createPortal(Content !== null ? getWrapper() : null, root);
      };
      ...
      var ModalProvider = function ModalProvider(_ref) {
         ...
         * 
         */
        var showModal = React.useCallback(function (_ref2) {
      ...
      var getByType = function getByType(type) {
        if (type === "error") {
          return styled.css(_templateObject$t || (_templateObject$t = _taggedTemplateLiteral(["\n      background: #870f0f;\n      ", " { color: #ffffff; }\n      ", " { color: #ffffffBF; }\n    "])), Title$2, Description);
        }
        if (type === "default" || type === "success") {
          return styled.css(_templateObject2$m || (_templateObject2$m = _taggedTemplateLiteral(["\n      background: #0bab65;\n      ", " { color: #2b2b2b; }\n      ", " { color: #2b2b2bBF; }\n    "])), Title$2, Description);
        }
        if (type === "warning") {
          return styled.css(_templateObject3$l || (_templateObject3$l = _taggedTemplateLiteral(["\n      background: #cfe10c;\n      ", " { color: #2b2b2b; }\n      ", " { color: #2b2b2bBF; }\n    "])), Title$2, Description);
        }
        return styled.css(_templateObject4$j || (_templateObject4$j = _taggedTemplateLiteral(["\n    background: #870f0f;\n    ", " { color: #ffffff; }\n    ", " { color: #ffffffBF; }\n  "])), Title$2, Description);
      };
      var Wrapper$o = styled(reactSpring.animated.div)(_templateObject5$f || (_templateObject5$f = _taggedTemplateLiteral(["\n  \n  margin-bottom: 10px;\n  max-width: 300px;\n\n  font-size: 12px;\n  position: relative;\n  padding: 16px;\n  border-radius: 3px;\n  word-break: break-word;\n  cursor: pointer;\n  pointer-events: auto;\n\n  ", "\n\n  "])), function (_ref) {
        var type = _ref.type;
      ...
      var getByPosition = function getByPosition(position) {
        if (position === "topLeft") {
          return styled.css(_templateObject$s || (_templateObject$s = _taggedTemplateLiteral(["\n      left: 0;\n      top: 0;\n    "])));
        }
        if (position === "topRight") {
          return styled.css(_templateObject2$l || (_templateObject2$l = _taggedTemplateLiteral(["\n      right: 0;\n      top: 0;\n    "])));
        }
        if (position === "bottomRight") {
          return styled.css(_templateObject3$k || (_templateObject3$k = _taggedTemplateLiteral(["\n      right: 0;\n      bottom: 0;\n    "])));
        }
        if (position === "bottomLeft") {
          return styled.css(_templateObject4$i || (_templateObject4$i = _taggedTemplateLiteral(["\n      left: 0;\n      bottom: 0;\n    "])));
        }
        return styled.css(_templateObject5$e || (_templateObject5$e = _taggedTemplateLiteral(["\n    left: 0;\n    top: 0;\n  "])));
      };
      ...
      var Container$2 = function Container(_ref) {
        ...
        var topRightTransitions = reactSpring.useTransition(notifications.filter(function (n) {
          return n.placement === "topRight";
        }), topRight);
        var topLeftTransitions = reactSpring.useTransition(notifications.filter(function (n) {
          return n.placement === "topLeft";
        }), topLeft);
        var bottomRightTransitions = reactSpring.useTransition(notifications.filter(function (n) {
          return n.placement === "bottomRight";
        }), bottomRight);
        var bottomLeftTransitions = reactSpring.useTransition(notifications.filter(function (n) {
        ...
        return /*#__PURE__*/reactDom.createPortal( /*#__PURE__*/React.createElement("div", null, /*#__PURE__*/React.createElement(Wrapper$n, {
          position: "topRight"
      ...
      var NotificationContext = /*#__PURE__*/React.createContext(null);
      ...
      var NotificationProvider = function NotificationProvider(_ref) {
        ...
        var addNotification = React.useCallback(function (_ref2) {
      ...
      var useNotifications = function useNotifications() {
        var notificationHelpers = React.useContext(NotificationContext);
      ...
      var Container$1 = function Container(_ref) {
        ...
        return /*#__PURE__*/reactDom.createPortal( /*#__PURE__*/React.createElement("div", null, /*#__PURE__*/React.createElement(Wrapper$m, null, tooltips.map(function (tooltip) {
      ...
      var getByStatus$1 = function getByStatus(status) {
        if (status === "error") {
          return styled.css(_templateObject3$j || (_templateObject3$j = _taggedTemplateLiteral(["\n      background: #870f0f;\n      ", " { color: #ffffff; }\n    "])), Title$1);
        }
        if (status === "default") {
          return styled.css(_templateObject4$h || (_templateObject4$h = _taggedTemplateLiteral(["\n      background: #0bab65;\n      ", " { color: #2b2b2b; }\n    "])), Title$1);
        }
        if (status === "warning") {
          return styled.css(_templateObject5$d || (_templateObject5$d = _taggedTemplateLiteral(["\n      background: #cfe10c;\n      ", " { color: #2b2b2b; }\n    "])), Title$1);
        }
        return styled.css(_templateObject6$b || (_templateObject6$b = _taggedTemplateLiteral(["\n    background: #0bab65;\n    ", " { color: #2b2b2b; }\n  "])), Title$1);
      };
      ...
      var TooltipProvider = function TooltipProvider(_ref) {
        ...
        var addTooltip = React.useCallback(function (id, item) {
        ...
        var removeTooltip = React.useCallback(function (id) {
          setTooltips(function (tooltips) {
      ...
      var QTDContext = /*#__PURE__*/React.createContext();
      ...
      var QTDProvider = function QTDProvider(_ref) {
        ...
        var _useState9 = React.useState("en"),
          _useState10 = _slicedToArray(_useState9, 2),
      ...
      var Checkmark$1 = styled.span(_templateObject3$i || (_templateObject3$i = _taggedTemplateLiteral(["\n\n  position: absolute;\n  top: 0;\n  left: 0;\n  height: 20px;\n  width: 20px;\n  border-radius: 6px;\n\n  ", "\n\n  ", "\n\n  //FIXME: Her ko\u015Fulda hover \xE7al\u0131\u015F\u0131yor. d\xFCzeltilmeli.\n  ", "\n\n"])), function (_ref) {
        ...
        return errorBorder ? styled.css(_templateObject4$g || (_templateObject4$g = _taggedTemplateLiteral(["\n        border: 1px solid #870f0f;\n      "]))) : styled.css(_templateObject5$c || (_templateObject5$c = _taggedTemplateLiteral(["\n        border: 1px solid #505A7D80;\n      "])));
      }, function (_ref2) {
        var isChecked = _ref2.isChecked;
        return isChecked && styled.css(_templateObject6$a || (_templateObject6$a = _taggedTemplateLiteral(["\n      &::after { \n        animation: ", " 0.5s;\n        content: \"\";\n        position: absolute;\n        left: 7px;\n        top: 3px;\n        width: 5px;\n        height: 11px;\n        border: solid #2196F3;\n        border-width: 0 3px 3px 0;\n        transform: rotate(45deg);\n      }\n    "])), bounceAnimation);
      }, function (_ref3) {
        var isChecked = _ref3.isChecked,
          errorBorder = _ref3.errorBorder;
        return !isChecked && !errorBorder && styled.css(_templateObject7$8 || (_templateObject7$8 = _taggedTemplateLiteral(["\n      ", ":hover & {    \n        border: 1px solid #505A7D;\n      }\n    "])), Wrapper$k);
      });
      ...
      var Wrapper$j = styled.li(_templateObject$o || (_templateObject$o = _taggedTemplateLiteral(["\n\n  display: flex;\n  align-items: center;\n  cursor: pointer;\n  transition: border-color 0.2s ease-out;\n  min-width: max-content;\n  padding: 10px 15px;\n\n  img {\n    width: 20px;\n    height: 20px;\n    pointer-events: none;\n  }\n\n  span {\n    color: #ffffff;\n    font-weight: 400;\n    font-size: 12px;\n    line-height: 12px;\n    white-space: nowrap;\n  }\n\n  &:not(:last-child) {\n    margin-bottom: 1px;\n  }\n\n  &:hover {\n    background-color: #3598FE20;\n  }\n\n  ", "\n\n  "])), function (_ref) {
        ...
        return selected && styled.css(_templateObject2$i || (_templateObject2$i = _taggedTemplateLiteral(["\n      background-color: #3598FE20;\n    "])));
      });
      ...
      var getBySize$2 = function getBySize(size) {
        if (size === "small") {
          return styled.css(_templateObject4$e || (_templateObject4$e = _taggedTemplateLiteral(["\n        font-size: 12px;\n        line-height: 12px;\n      "])));
        }
        if (size === "medium") {
          return styled.css(_templateObject5$a || (_templateObject5$a = _taggedTemplateLiteral(["\n        font-size: 13px;\n        line-height: 13px;\n      "])));
        }
        if (size === "large") {
          return styled.css(_templateObject6$9 || (_templateObject6$9 = _taggedTemplateLiteral(["\n        font-size: 14px;\n        line-height: 14px;\n      "])));
        }
        return styled.css(_templateObject7$7 || (_templateObject7$7 = _taggedTemplateLiteral(["\n      font-size: 12px;\n      line-height: 12px;\n    "])));
      };
      ...
      var getBySize$1 = function getBySize(size) {
        if (size === "small") {
          return styled.css(_templateObject$m || (_templateObject$m = _taggedTemplateLiteral(["\n      font-size: 12px;\n    "])));
        }
        if (size === "medium") {
          return styled.css(_templateObject2$g || (_templateObject2$g = _taggedTemplateLiteral(["\n      font-size: 13px;\n    "])));
        }
        if (size === "large") {
          return styled.css(_templateObject3$f || (_templateObject3$f = _taggedTemplateLiteral(["\n      font-size: 14px;\n    "])));
        }
        return styled.css(_templateObject4$d || (_templateObject4$d = _taggedTemplateLiteral(["\n    font-size: 12px;\n  "])));
      };
      ...
      var InputLabel = styled.label(_templateObject7$6 || (_templateObject7$6 = _taggedTemplateLiteral(["\n  \n  display: block;\n  position: relative;\n  max-height: 0;\n  font-weight: 500;\n  pointer-events: none;\n\n  &::before {\n\n    color: #ffffff99;\n    content: attr(data-content);\n    display: inline-block;\n    filter: blur(0);\n    backface-visibility: hidden;\n    transform-origin: left top;\n    transition: transform 0.2s ease;\n    position: relative;\n\n  }\n\n  &::before {\n    transform: translate3d(0, -32px, 0) scale3d(.8, .8, 1);\n  }\n\n  ", "\n  /*\n  &::before + ", ":placeholder-shown {\n    transform: translate3d(0, -32px, 0) scale3d(.8, .8, 1);\n  }\n\n  &::before,\n  ", ":focus + &::before {\n    transform: translate3d(0, -40px, 0) scale3d(0.76, 0.76, 1);\n  }\n\n  ", ":focus + &::before {\n    color: #ffffff99;\n  }\n  */\n\n  "])), function (_ref) {
        ...
        return filled && styled.css(_templateObject8$6 || (_templateObject8$6 = _taggedTemplateLiteral(["\n      &::before {\n        transform: translate3d(0, -40px, 0) scale3d(0.76, 0.76, 1);\n      }\n    "])));
      ...
      function FloatingLabel(_ref) {
        ...
        var _useState = React.useState("small"),
          _useState2 = _slicedToArray(_useState, 2),
          sizeStyle = _useState2[0],
          SetSizeStyle = _useState2[1];
        var _useState3 = React.useState(""),
      ...
      var Image$1 = function Image(props) {
        var _useContext = React.useContext(QTDContext),
        ...
        return /*#__PURE__*/React.createElement(React.Suspense, null, /*#__PURE__*/React.createElement(Image, null));
      };
      ...
      var Icon$3 = styled.div(_templateObject3$e || (_templateObject3$e = _taggedTemplateLiteral(["\n  \n  transition: transform .25s ease-out;\n\n  ", "\n  \n  svg {\n      \n    width: 20px;\n    height: 20px;\n    fill: #ffffff;\n\n  }\n\n  "])), function (_ref3) {
        var open = _ref3.open;
        return open && styled.css(_templateObject4$c || (_templateObject4$c = _taggedTemplateLiteral(["\n      transform: rotate(-180deg);\n    "])));
      });
      ...
      var getBySize = function getBySize(size) {
        ...
        return styled.css(_templateObject10$3 || (_templateObject10$3 = _taggedTemplateLiteral(["\n    height: 40px; \n    padding: 0 7px 0 12px;\n  "])));
      };
      var getByVariant = function getByVariant(variant) {
        if (variant === "filled") {
          return styled.css(_templateObject11$2 || (_templateObject11$2 = _taggedTemplateLiteral(["\n      transition: background-color 0.2s ease;\n      background-color: #0E153180;\n\n      &:hover {\n        background-color: #0E1531BF;\n      }\n    "])));
        }
        if (variant === "inverted") {
          return styled.css(_templateObject12$1 || (_templateObject12$1 = _taggedTemplateLiteral(["\n      border: 1px solid #505A7D99;\n\n    &:hover {\n      border-color: #3598FE;\n    }\n    "])));
        }
        return styled.css(_templateObject13$1 || (_templateObject13$1 = _taggedTemplateLiteral(["\n    transition: background-color 0.2s ease;\n    background-color: #0E153180;\n\n    &:hover {\n      background-color: #0E1531BF;\n    }\n  "])));
      };
      ...
      var SimplebarWrapper = styled.div(_templateObject$j || (_templateObject$j = _taggedTemplateLiteral(["\n\n  ", "\n\n  ", "\n\n  "])), function (_ref) {
        ...
        return styled.css(_templateObject3$d || (_templateObject3$d = _taggedTemplateLiteral(["\n      ", " {\n        width: 8px;\n      }\n    "])), "." + $track + "." + $vertical);
      });
      ...
      var Wrapper$f = styled.div(_templateObject$i || (_templateObject$i = _taggedTemplateLiteral(["\n  \n  min-width: 100%;\n  background-color: #1D2649;\n  border-radius: 5px;\n  overflow: hidden;\n  position: absolute;\n  z-index: 2;\n  box-shadow: 0 0 10px rgba(0,0,0,.25);\n\n  transform-origin: 50% 1%;\n  transform-box: fill-box;\n  transition-timing-function: cubic-bezier(.75,-0.5,0,1.25);\n  \n  ul {\n\n    min-width: max-content;\n\n  }\n\n  ", "\n\n  ", "\n\n  ", "\n\n  ", "\n\n  "])), function (_ref) {
        var position = _ref.position;
        return position === "bottom" && styled.css(_templateObject2$d || (_templateObject2$d = _taggedTemplateLiteral(["\n      top: calc(100% + 10px);\n    "])));
      }, function (_ref2) {
        var position = _ref2.position;
        return position === "top" && styled.css(_templateObject3$c || (_templateObject3$c = _taggedTemplateLiteral(["\n      bottom: calc(100% + 10px);\n    "])));
      }, function (_ref3) {
        var direction = _ref3.direction;
        return direction === "left" && styled.css(_templateObject4$b || (_templateObject4$b = _taggedTemplateLiteral(["\n      left: 0;\n    "])));
      }, function (_ref4) {
        var direction = _ref4.direction;
        return direction === "right" && styled.css(_templateObject5$7 || (_templateObject5$7 = _taggedTemplateLiteral(["\n      right: 0;\n    "])));
      });
      ...
      function Menu$2(props) {
        ...
        var _useState = React.useState("bottom"),
          _useState2 = _slicedToArray(_useState, 2),
      ...
      var Wrapper$e = styled.div(_templateObject$h || (_templateObject$h = _taggedTemplateLiteral(["\n\n  position: relative;\n\n  ", "\n\n  "])), function (_ref) {
        ...
        return disabled && styled.css(_templateObject2$c || (_templateObject2$c = _taggedTemplateLiteral(["\n      opacity: .75;\n      cursor: not-allowed;\n      pointer-events: none;\n    "])));
      });
      ...
      var Select$1 = /*#__PURE__*/React.forwardRef(function (props, ref) {
        ...
        var _useState = React.useState(false),
          ...
          isOpen = _useState2[0],
          SetIsOpen = _useState2[1];
        var _useState3 = React.useState(mode === "single" ? "" : []),
          _useState4 = _slicedToArray(_useState3, 2),
      ...
      var Select = styled.div(_templateObject3$b || (_templateObject3$b = _taggedTemplateLiteral(["\n\n  display: flex;\n  align-items: center;\n  cursor: pointer;\n  user-select: none;\n  padding: 10px 18px 10px 18px;\n  \n  border-radius: 5px 5px 0 0;\n\n  ", "\n\n  "])), function (_ref) {
        var open = _ref.open;
        return open && styled.css(_templateObject4$a || (_templateObject4$a = _taggedTemplateLiteral(["\n      background-color: #050A20;\n\n      ", " {\n        color: #ffffff;\n      }\n\n      ", " {\n        svg {\n          transform: rotate(180deg);\n        }\n      }\n    "])), Label, Container);
      });
      ...
      var FormWrapper$1 = /*#__PURE__*/React.memo(FormWrapper);
      ...
      function FormStore() {
        ...
        var _useState3 = React.useState(name),
          _useState4 = _slicedToArray(_useState3, 2),
          formId = _useState4[0],
      ...
      function Button$1(props) {
        var _props$id = props.id,
          id = _props$id === void 0 ? uuid.v4() : _props$id,
      ...
      var Group = /*#__PURE__*/React.forwardRef(function (props, ref) {
        var _props$name = props.name,
          ...
          _props$children = props.children,
          children = _props$children === void 0 ? null : _props$children;
        var _useState = React.useState(message),
          _useState2 = _slicedToArray(_useState, 2),
      ...
      var ALink = function ALink(_ref) {
        ...
        var getRoute = function getRoute() {
          ...
          reactRouterDom.useMatch({
            path: resolved.pathname,
            end: true
          });
          return /*#__PURE__*/React.createElement("div", null, /*#__PURE__*/React.createElement(reactRouterDom.NavLink, _extends({
      ...
      var Title = styled.div(_templateObject2$a || (_templateObject2$a = _taggedTemplateLiteral(["\n\n  background-color: #1D2649;\n  width: 100%;\n  height: 60px;\n  padding: 0 20px 0 20px;\n  margin-bottom: 1px;\n\n  cursor: pointer;\n  transition: background-color 0.3s ease-out;\n\n  display: flex;\n  justify-content: flex-start;\n  align-items: center;\n  \n  span {\n    font-size: 13px;\n    color: #ffffff99;\n  }\n\n  &:hover:not(&.activeTitle) {\n    background-color: #3396FB40;\n  }\n\n  ", "\n\n  "])), function (_ref) {
        ...
        return active && styled.css(_templateObject3$a || (_templateObject3$a = _taggedTemplateLiteral(["\n      background-color: #3396FB80;\n      span {\n        color: #ffffff;\n      }\n\n      .icon {\n        color: #ffffff;\n      }\n\n      .arrow {\n        fill: #ffffff;\n      }\n    "])));
      });
      ...
      function Panel(_ref) {
        ...
        var _useState5 = React.useState("0px"),
          _useState6 = _slicedToArray(_useState5, 2),
          height = _useState6[0],
      ...
      var Wrapper$a = styled.div(_templateObject$b || (_templateObject$b = _taggedTemplateLiteral(["\n\n  display: flex;\n  justify-content: flex-start;\n  align-items: center;\n  height: ", ";\n\n  background-color: #1D2649;\n  padding: 0 20px 0 20px;\n  margin-bottom: 1px;\n\n  cursor: pointer;\n  transition: background-color 0.3s ease-out;\n  \n  span {\n    user-select: none;\n    font-size: 13px;\n    color: #ffffff99;\n  }\n\n  ", "\n\n  ", "\n\n  ", "\n\n"])), function (props) {
        ...
        return !$isActive && styled.css(_templateObject2$9 || (_templateObject2$9 = _taggedTemplateLiteral(["\n      &:hover {\n        background-color: #3396FB40;\n      }\n    "])));
      }, function (_ref2) {
        var $isActive = _ref2.$isActive;
        return $isActive && styled.css(_templateObject3$9 || (_templateObject3$9 = _taggedTemplateLiteral(["\n      transition-duration: 0ms;\n      background-color: #3396FB80;\n\n      span {\n        color: #ffffff;\n      }\n      \n    "])));
      }, function (_ref3) {
        var $isOpen = _ref3.$isOpen;
        return $isOpen && styled.css(_templateObject4$8 || (_templateObject4$8 = _taggedTemplateLiteral(["\n      span {\n        color: #ffffff;\n      }\n    "])));
      });
      var Icon$2 = styled.div(_templateObject5$6 || (_templateObject5$6 = _taggedTemplateLiteral(["\n\n  font-size: ", ";\n  width: ", ";\n  height: ", ";\n\n  margin-right: 8px;\n  color: #ffffff99;\n  display: flex;\n  align-items: center;\n\n  ", "\n\n"])), function (props) {
        ...
        return ($isOpen || $isActive) && styled.css(_templateObject6$5 || (_templateObject6$5 = _taggedTemplateLiteral(["\n      color: #ffffff;\n    "])));
      });
      ...
      var Arrow$1 = styled.svg(_templateObject8$3 || (_templateObject8$3 = _taggedTemplateLiteral(["\n\n  transition: all 0.25s ease-out;\n  margin-left: auto;\n  transform: rotate(0deg);\n  fill: #ffffff99;\n\n  ", "\n\n  ", "\n\n  ", "\n\n"])), function (_ref5) {
        ...
        return $isOpen && styled.css(_templateObject9$1 || (_templateObject9$1 = _taggedTemplateLiteral(["\n      transform: rotate(-180deg);\n      fill: #ffffff;\n    "])));
      }, function (_ref6) {
        var $isActive = _ref6.$isActive;
        return $isActive && styled.css(_templateObject10$1 || (_templateObject10$1 = _taggedTemplateLiteral(["\n      fill: #ffffff;\n    "])));
      }, function (_ref7) {
        var $isNormal = _ref7.$isNormal;
        return $isNormal && styled.css(_templateObject11$1 || (_templateObject11$1 = _taggedTemplateLiteral(["\n      transform: rotate(-90deg);\n    "])));
      });
      ...
      var Wrapper$9 = styled.div(_templateObject$a || (_templateObject$a = _taggedTemplateLiteral(["\n\n  height: ", ";\n\n  padding: 0 20px 0 50px;\n  background-color: #3396FB1A;\n  margin-bottom: 1px;\n  display: flex;\n  align-items: center;\n  overflow: hidden;\n  transition: background-color 0.3s ease-out;\n\n  span {\n    font-size: 12px;\n    color: #ffffff;\n    user-select: none;\n  }\n\n  ", "\n\n  "])), function (props) {
        ...
        var $isActive = _ref.$isActive;
        return !$isActive && styled.css(_templateObject2$8 || (_templateObject2$8 = _taggedTemplateLiteral(["\n      &:hover {\n        background-color: #3396FB40;\n      }\n    "])));
      });
      ...
      var SpinAnimation = styled.keyframes(_templateObject$8 || (_templateObject$8 = _taggedTemplateLiteral(["\n  0% {\n    transform: rotate(0deg);\n  }\n  100% {\n    transform: rotate(360deg);\n  }\n"])));
      ...
      var getStyleByType = function getStyleByType(type) {
        ...
        if (type === "generic") {
          return styled.css(_templateObject4$5 || (_templateObject4$5 = _taggedTemplateLiteral(["\n      span {\n        color: #ffffff;\n      }\n\n      background-color: #1D2649;\n      \n      &:hover {\n        background: linear-gradient(-45deg,#197ADD,#6CB5FF);\n      }\n    "])));
        }
        if (type === "approved") {
      ...
      var getSelectedStyleByType = function getSelectedStyleByType(type) {
        ...
        return styled.css(_templateObject12 || (_templateObject12 = _taggedTemplateLiteral(["background: linear-gradient(-45deg,#197ADD,#6CB5FF);"])));
      };
      var getSVGStyleBySize = function getSVGStyleBySize(size) {
        ...
        return styled.css(_templateObject17 || (_templateObject17 = _taggedTemplateLiteral(["svg { width: 12px; }"])));
      };
      var getIconStyleBySize = function getIconStyleBySize(size) {
        ...
        return styled.css(_templateObject22 || (_templateObject22 = _taggedTemplateLiteral(["font-size: 20px;"])));
      };
      var WrapperContent = styled.css(_templateObject23 || (_templateObject23 = _taggedTemplateLiteral(["\n\n  height: 40px;\n  display: flex;\n  align-items: center;\n  justify-content: center;\n  position: relative;\n\n  border-radius: 5px;\n  padding: 0 10px;\n  cursor: pointer;\n  \n  svg {\n    fill: #ffffff;\n  }\n\n  span {\n    color: #ffffff;\n    font-weight: bold;\n    font-size: 12px;\n    line-height: 12px;\n    user-select: none;\n    transition: color 0.2s ease-out;\n  }\n\n  ", "\n\n  ", "\n\n  ", "\n\n  ", "\n\n  ", " \n\n  ", "\n\n  ", "\n  ", "\n  ", "\n\n"])), function (_ref) {
        var stretch = _ref.stretch;
        return stretch && styled.css(_templateObject24 || (_templateObject24 = _taggedTemplateLiteral(["\n      width: 100%;\n    "])));
      }, function (_ref2) {
        var shape = _ref2.shape;
        return shape === "circle" && styled.css(_templateObject25 || (_templateObject25 = _taggedTemplateLiteral(["\n      border-radius: 100%;\n    "])));
      }, function (_ref3) {
        var icon = _ref3.icon;
        return icon && styled.css(_templateObject26 || (_templateObject26 = _taggedTemplateLiteral(["\n      padding: 0 12px 0 10px;\n    "])));
      }, function (_ref4) {
        var disabled = _ref4.disabled;
        return disabled && styled.css(_templateObject27 || (_templateObject27 = _taggedTemplateLiteral(["\n      pointer-events: none;\n      filter: grayscale(50%);\n      opacity: .5;\n    "])));
      }, function (_ref5) {
        var type = _ref5.type;
        return type !== "default" && type !== "link" && styled.css(_templateObject28 || (_templateObject28 = _taggedTemplateLiteral(["\n      span {\n        font-weight: bold;\n        letter-spacing: -.21px;\n      }\n    "])));
      }, function (_ref6) {
        var svg = _ref6.svg,
          shape = _ref6.shape,
          loading = _ref6.loading;
        return svg && shape !== "circle" && loading && styled.css(_templateObject29 || (_templateObject29 = _taggedTemplateLiteral(["\n      padding-left: 34px;\n    "])));
      }, function (_ref7) {
        var size = _ref7.size,
          svg = _ref7.svg;
      ...
      var SVG = styled.div(_templateObject30 || (_templateObject30 = _taggedTemplateLiteral(["\n  \n  ", "\n\n  ", "\n\n  "])), function (_ref10) {
        ...
        return !singleIcon && styled.css(_templateObject31 || (_templateObject31 = _taggedTemplateLiteral(["\n      margin-right: 7px;\n    "])));
      });
      ...
      var Icon$1 = styled.div(_templateObject37 || (_templateObject37 = _taggedTemplateLiteral(["\n\n  color: #ffffff;\n  \n  ", "\n\n  ", "\n\n  "])), function (_ref12) {
        ...
        return useIconPadding && styled.css(_templateObject38 || (_templateObject38 = _taggedTemplateLiteral(["\n      margin-right: 7px;\n    "])));
      });
        ...
        var getIcon = function getIcon() {
          ...
          if (svg) {
            return /*#__PURE__*/React.createElement(SVG, {
              singleIcon: !children,
              size: size
            }, /*#__PURE__*/React.createElement(reactSvg.ReactSVG, {
              src: svg
            }));
          }
          return null;
      ...
      var Wrapper$6 = styled.div(_templateObject$6 || (_templateObject$6 = _taggedTemplateLiteral(["\n\n  position: relative;\n  cursor: pointer;\n  border-radius: 4px;\n\n  display: flex;\n  justify-content: center;\n  align-items: center;\n\n  &::before {\n\n    position: absolute;\n    top: 50%;\n    right: 0;\n    left: 0;\n    z-index: 1;\n    height: 30px;\n    -webkit-transform: translateY(-50%);\n    transform: translateY(-50%);\n    content: \"\";\n\n  }\n\n  span {\n\n    font-size: 13px;\n    letter-spacing: -.5;\n    font-weight: 400;\n\n    display: flex;\n    justify-content: center;\n    align-items: center;\n\n    position: relative;\n    min-width: 30px;\n    height: 30px;\n    line-height: 30px;\n    border-radius: 50px;\n\n    transition: background-color 0.15s ease-out;\n\n  }\n\n  &:hover {\n\n    span {\n      color: #3598FE;\n      background-color: #0E1531;\n    }\n\n  }\n\n  ", "\n\n  ", "\n\n  ", "\n\n  ", "\n\n"])), function (_ref) {
        ...
        return today && styled.css(_templateObject2$5 || (_templateObject2$5 = _taggedTemplateLiteral(["\n      span {\n        border: 1px solid #3598FE80;\n      }\n    "])));
      }, function (_ref2) {
        var selected = _ref2.selected;
        return selected && styled.css(_templateObject3$5 || (_templateObject3$5 = _taggedTemplateLiteral(["\n      span {\n        color: #3598FE;\n        background-color: #0E1531;\n      }\n    "])));
      }, function (_ref3) {
        var current = _ref3.current;
        return current ? styled.css(_templateObject4$4 || (_templateObject4$4 = _taggedTemplateLiteral(["\n        span {\n          color: #ffffff;\n        }\n      "]))) : styled.css(_templateObject5$3 || (_templateObject5$3 = _taggedTemplateLiteral(["\n        span {\n          color: #ffffff80;\n        }\n      "])));
      }, function (_ref4) {
        var disabled = _ref4.disabled;
        return disabled && styled.css(_templateObject6$3 || (_templateObject6$3 = _taggedTemplateLiteral(["\n      pointer-events: none;\n      \n      &::before {\n        background-color: none;\n        background-color: #0E153180;\n      }\n\n      span {\n        background: 0 0;\n        color: #ffffff40;\n      }\n    "])));
      });
      ...
      var Calendar = /*#__PURE__*/React.forwardRef(function (props, ref) {
        ...
        var _useState7 = React.useState(moment()),
          _useState8 = _slicedToArray(_useState7, 2),
      ...
      var Input = /*#__PURE__*/React.forwardRef(function (props, ref) {
        ...
        var _useState9 = React.useState(modules_02792f97.medium),
          _useState10 = _slicedToArray(_useState9, 2),
          sizeStyle = _useState10[0],
          SetSizeStyle = _useState10[1];
        var _useState11 = React.useState(modules_02792f97.filled),
          _useState12 = _slicedToArray(_useState11, 2),
      ...
      var Wrapper$3 = styled.div(_templateObject$3 || (_templateObject$3 = _taggedTemplateLiteral(["\n  \n  position: relative;\n\n  ", "\n\n  "])), function (_ref) {
        var disabled = _ref.disabled;
        return disabled && styled.css(_templateObject2$2 || (_templateObject2$2 = _taggedTemplateLiteral(["\n      opacity: .75;\n      cursor: not-allowed;\n      pointer-events: none;\n    "])));
      });
      ...
      */
      ...
      `
      */
      var showBounceAnimation = styled.keyframes(_templateObject3$1 || (_templateObject3$1 = _taggedTemplateLiteral(["\n  0% { transform: scale(.2) }\n  50% { transform: scale(1.1) }\n  75% { transform: scale(0.9) }\n  100% { transform: scale(1) }\n"])));
      ...
      var useCreateDynamicStyle = function useCreateDynamicStyle(style, handler) {
        var id = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : nanoid.nanoid(11);
        React.useEffect(function () {
      ...
      exports.ALink = ALink;
      exports.AddDefaultThemeStyle = AddDefaultThemeStyle;
      exports.AddZero = AddZero;
      exports.ArrowIcon = Arrow$2;
      ...
      exports.MultiSelectArrow = MultiSelectArrow;
      exports.Notification = Notification;
      exports.QTDContext = QTDContext;
      exports.QTDProvider = QTDProvider;
      exports.Radio = Radio;
      ...
      exports.UniUpperCase = UniUpperCase;
      exports.UpdateThemeStyle = UpdateThemeStyle;
      exports.UploadIcon = Upload;
      exports.useAddExternalCSS = useAddExternalCSS;
      exports.useConnectionStatus = useConnectionStatus;
      exports.useConstructor = useConstructor;
      exports.useCreateDynamicStyle = useCreateDynamicStyle;
      exports.useCreateStyledStyle = useCreateStyledStyle;
      exports.useMultiQuery = useMultiQuery;
