export const getImageSizeBySize = (size:string) => {
  ...
  if ( size === "xs" )   return {width: "14px", height: "14px"};
...
export const getOptionSizeBySize = (size:string) => {
  ...
  if ( size === "xs" )   return {padding: "0 10px 0 10px", height: "28px"};
...
export const getFontSizeBySize = (size:string) => {
  ...
  if ( size === "sm" )   return {fontSize: "13px", lineHeight: "13px", fontWeight: "500"};
