...
export const PreDefined: Story = {
  args: {
    action:
      "https://api.imgbb.com/1/upload?key=fa70bcfc032ed5fd20eafb19d21742b2",
    filePath:
...
export const Error: Story = {
  args: {
    action:
      "https://api.imgbb.com/1/upload?key=fa70bcfc032ed5fd20eafb19d21742b2",
    filePath:
      "https://assets.xboxservices.com/assets/94/d6/94d66c09-f466-4ed3-9b1e-c098f2737f5b.jpg?n=Xbox-Series-X_Content-Placement-0_Next-Gen-Framerates_788x444_01.jpg",
    maxFileSize: 1024,
    fileHeight: "100%",
